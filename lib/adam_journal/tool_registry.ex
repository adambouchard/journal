defmodule AdamJournal.ToolRegistry do
  @moduledoc """
  ...
  @tools %{
    "check_calendar" => AdamJournal.Tools.CheckCalendar,
    "book_meeting" => AdamJournal.Tools.BookMeeting
  }
  ...
  defp config_for("check_calendar"), do: [category: :integration, config_key: {:adam_journal, :google_calendar}]
  defp config_for("book_meeting"), do: [category: :integration, config_key: {:adam_journal, :google_calendar}]
