defmodule AdamJournal.Admin.SettingsLive do
  use Sigil.Live
  import Sigil.HTML, only: [escape: 1]

  @impl true
  def mount(_params, socket) do
    settings = AdamJournal.Settings.all()
  ...
  def handle_event("save_site", params, socket) do
    AdamJournal.Settings.put("site_name", params["site_name"] || "")
    AdamJournal.Settings.put("site_tagline", params["site_tagline"] || "")
  ...
  def handle_event("save_email", params, socket) do
    ...
    case AdamJournal.Settings.update_email(user, new_email) do
      {:ok, updated_user} ->
        {:noreply,
         Sigil.Live.assign(socket,
  ...
  def handle_event("save_password", params, socket) do
    ...
    cond do
      ...
      true ->
        case AdamJournal.Settings.update_password(user, new_pw) do
          {:ok, _} ->
