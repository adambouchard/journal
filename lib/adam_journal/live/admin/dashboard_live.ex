defmodule AdamJournal.Admin.DashboardLive do
  use Sigil.Live
  ...
  def mount(_params, socket) do
    ...
    conversations = AdamJournal.Conversations.list_conversations(limit: 5)

    published_count = Enum.count(posts, & &1.published)
    draft_count = Enum.count(posts, &(!&1.published))
    active_count = AdamJournal.Conversations.count_active()
