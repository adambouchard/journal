defmodule AdamJournal.LoginLive do
  use Sigil.Live
  ...
  def render(assigns) do
    ...
    <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
      <div class="sm:mx-auto sm:w-full sm:max-w-sm">
        <h1 class="text-center font-serif text-3xl font-semibold tracking-tight text-stone-900 dark:text-stone-100">Adam Journal</h1>
